...
def upgrade():
    ...
    conn.execute(
        "ALTER TABLE public.device_codes ALTER COLUMN verification_uri TYPE varchar(500);"
    )
...
def downgrade():
    ...
    conn.execute(
        "ALTER TABLE public.device_codes ALTER COLUMN verification_uri TYPE varchar(80);"
    )
